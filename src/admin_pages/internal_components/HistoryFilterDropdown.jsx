  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none bg-gray-800 text-white px-4 py-2 pr-8 rounded border border-gray-600 focus:border-blue-500 focus:outline-none cursor-pointer"
      >
